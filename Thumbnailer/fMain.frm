VERSION 5.00
Begin VB.Form fMain 
   Caption         =   "Í¼Æ¬ä¯ÀÀÆ÷  [»ªÆÕÈí¼þ - www.cnpopsoft.com]"
   ClientHeight    =   8280
   ClientLeft      =   60
   ClientTop       =   465
   ClientWidth     =   10560
...
'#########################################################################
'¡ï¡ï¡ï¡ï¡ï         http://www.cnpopsoft.com [»ªÆÕÈí¼þ]         ¡ï¡ï¡ï¡ï¡ï
'¡ï¡ï¡ï¡ï¡ï             VB×¨ÒµÂÛÎÄÓëÔ´ÂëÜöÝÍ                    ¡ï¡ï¡ï¡ï¡ï
'#########################################################################
...
Private Sub Form_Load()
    ...
    If (m_bLoaded = False) Then
        ...
        With ucToolbar
            ...
            Call .AddButton("ºóÍË", 0, , , False)
            Call .AddButton("Ç°½ø", 1, , , False)
            Call .AddButton("ÉÏ¼¶", 2, , , False)
            Call .AddButton(, , , [eSeparator])
            Call .AddButton("Ë¢ÐÂ", 3, , , False)
            Call .AddButton(, , , [eSeparator])
            Call .AddButton("²é¿´", 4, , [eDropDown], False)
            Call .AddButton("È«ÆÁ", 6, , , False)
            Call .AddButton(, , , [eSeparator])
'           Call .AddButton("²ÎÊý", 7, , , False)
'           Call .AddButton(, , , [eSeparator])
            Call .AddButton("Î¬»¤", 8, , , False)
...
Private Sub mnuHelp_Click(Index As Integer)
    ...
    Call MsgBox("»ªÆÕÈí¼þ Í¼Æ¬ä¯ÀÀÆ÷ v" & App.Major & "." & App.Minor & "." & App.Revision & vbCrLf & vbCrLf & _
                "Davidwu 2007" & Space$(15), _
                vbInformation, "¹ØÓÚ")
End Sub
...
Private Sub tmrExploreFolder_Timer()
    ...
    If (Not m_bEnding) Then
        ...
        '-- Show # of items found
        ucStatusbar.PanelText(3) = Format$(ucThumbnailView.Count, "ÕÒµ½ #,#0 ÕÅÍ¼Æ¬")
