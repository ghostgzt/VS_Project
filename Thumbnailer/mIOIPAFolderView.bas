Attribute VB_Name = "mIOIPAFolderView"
'#########################################################################
...
Public Type IPAOHookStructFolderView
    lpVTable    As Long                    'VTable pointer
    IPAOReal    As IOleInPlaceActiveObject 'Un-AddRefed pointer for forwarding calls
    Ctl         As ucFolderView            'Un-AddRefed native class pointer for making Friend calls
    ThisPointer As Long
End Type
...
Public Sub InitIPAO(IPAOHookStruct As IPAOHookStructFolderView, Ctl As ucFolderView)
...
Public Sub TerminateIPAO(IPAOHookStruct As IPAOHookStructFolderView)
    With IPAOHookStruct
...
Private Function AddRef(This As IPAOHookStructFolderView) As Long
    AddRef = This.IPAOReal.AddRef
End Function

Private Function Release(This As IPAOHookStructFolderView) As Long
    Release = This.IPAOReal.Release
End Function

Private Function QueryInterface(This As IPAOHookStructFolderView, riid As GUID, pvObj As Long) As Long
...
Private Function GetWindow(This As IPAOHookStructFolderView, phwnd As Long) As Long
    GetWindow = This.IPAOReal.GetWindow(phwnd)
End Function

Private Function ContextSensitiveHelp(This As IPAOHookStructFolderView, ByVal fEnterMode As Long) As Long
    ContextSensitiveHelp = This.IPAOReal.ContextSensitiveHelp(fEnterMode)
End Function

Private Function TranslateAccelerator(This As IPAOHookStructFolderView, lpMsg As MSG) As Long
...
Private Function OnFrameWindowActivate(This As IPAOHookStructFolderView, ByVal fActivate As Long) As Long
    OnFrameWindowActivate = This.IPAOReal.OnFrameWindowActivate(fActivate)
End Function

Private Function OnDocWindowActivate(This As IPAOHookStructFolderView, ByVal fActivate As Long) As Long
    OnDocWindowActivate = This.IPAOReal.OnDocWindowActivate(fActivate)
End Function

Private Function ResizeBorder(This As IPAOHookStructFolderView, prcBorder As RECT, ByVal puiWindow As IOleInPlaceUIWindow, ByVal fFrameWindow As Long) As Long
    ResizeBorder = This.IPAOReal.ResizeBorder(VarPtr(prcBorder), puiWindow, fFrameWindow)
End Function

Private Function EnableModeless(This As IPAOHookStructFolderView, ByVal fEnable As Long) As Long
