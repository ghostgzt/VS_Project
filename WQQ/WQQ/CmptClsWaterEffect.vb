...
#Region "Variables - including information on what they do"
        ...
        Private _dropRadius As Integer = 10
        ...
        Private _dropHeight As Short = 100
        ...
        Private _dampener As Integer = 2.5
...
#Region "The Subroutines - You don't need to fiddle with these. Play with the Events section instead"
        ...
        Protected Overloads Sub Dispose(ByVal disposing As Boolean)
            ...
            If (disposing) Then
                If Not (components.Components.Count = Nothing) Then
                    components.Dispose()
                End If
            End If
        ...
        Private Sub effectTimer_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles effectTimer.Tick
            If ((_stopRipples = False) And (_weHaveWaves)) Then
                Invalidate()
                ProcessWaves()
            End If
        End Sub
        Public Sub fluidEffectControl_Paint(ByVal sender As Object, ByVal e As System.Windows.Forms.PaintEventArgs) Handles MyBase.Paint
...
#Region "Events - MouseDown by default, add extra events here"
        ...
        Private Sub fluidEffectControl_MouseMove(ByVal send As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles MyBase.MouseMove
